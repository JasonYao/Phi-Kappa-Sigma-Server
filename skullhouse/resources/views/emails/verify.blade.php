...
@section('text')
	...
	<h1><span>Email confirmation</span></h1>
	<hr>

	<p>
		Click here to confirm your email account and gain access to your profile: {{ URL::to('register/verify/' . $user->confirmationCode . '/') }}
	</p>
